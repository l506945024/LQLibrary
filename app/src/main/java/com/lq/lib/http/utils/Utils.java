...
public final class Utils {
    ...
    private static String getDiskFilesDir() {
        return isSDCardExist() && Api.getContext().getExternalFilesDir(null) != null ? Api.getContext().getExternalFilesDir(null).getPath() : Api.getContext().getFilesDir().getPath();
